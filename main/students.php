...
<a  href="index.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a>
			<?php 
			include('../connect.php');
				$result = $db->prepare("SELECT * FROM membership ORDER BY first_name ASC");
				$result->execute();
...
<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			?>
			<td align="center"><a href="viewstudent.php?id=<?php echo $row['username']; ?>" title="View Member"><?php echo $row['username'] ?></a></td>
			<td><?php echo $row['first_name']; ?> <?php echo $row['middle_name']; ?> <?php echo $row['last_name']; ?></td>
			<td><?php echo $row['gender']; ?></td>
			<td><?php echo $row['DOB']; ?></td>
			<td><?php echo $row['phone_number']; ?></td>
            <td> <?php echo $row['district_name']; ?></td>
			<td><a title="Click to view the Member" href="viewstudent.php?id=<?php echo $row['username']; ?>"><button class="btn btn-success btn-mini"><i class="icon-search"></i> View</button> </a>
			<a  title="Click to edit the Member" href="editstudent.php?id=<?php echo $row['username']; ?>"><button class="btn btn-warning btn-mini"><i class="icon-edit"></i> Edit</button> </a>
