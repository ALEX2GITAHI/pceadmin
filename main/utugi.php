...
<a  href="district.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a>
			<?php 
			include('../connect.php');
				$result = $db->prepare("SELECT * FROM member WHERE district_name = 'utugi'");
				$result->execute();
			...
			Total Number of UTUGI Members:  <font color="green" style="font:bold 22px 'Aleo';">[<?php echo $rowcount;?>]</font>
			</div>
...
<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			// Database connection parameters
				...
				$selectedCountry = isset($_GET['district_name']) ? $_GET['district_name'] : 'utugi';
