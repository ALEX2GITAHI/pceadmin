...
<a  href="index.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a><form action="saveyouth.php" method="post" enctype="multipart/form-data"><br>
<h4><i class="icon-edit icon-large"></i></h4>
<div id="ac">
<input type="hidden" name="memi" value="<?php echo $id; ?>" />
<span>Memebr ID: </span><input type="text" style="width:265px; height:30px;"   name="membership_id" readonlyired /><br>
...
<option>NO</option>
<option>CARD</option>
<option>BRIGDE</option>
<option>BOTH CARD ADN BRIGDE</option>
</select><br>
<div > <br>
