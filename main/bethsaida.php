...
<div class="container-fluid">
	...
	<div class="contentheader">
			...
			<li class="active">Bethsaida</li>
			</ul>


<div style="margin-top: -19px; margin-bottom: 21px;">
<a  href="district.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a>
			<?php 
			include('../connect.php');
				$result = $db->prepare("SELECT * FROM member WHERE district_name = 'bethsaida'");
				$result->execute();
			...
			Total Number of BETHSAIDA Members:  <font color="green" style="font:bold 22px 'Aleo';">[<?php echo $rowcount;?>]</font>
			</div>
...
<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			// Database connection parameters
				...
				// Get selected country from the URL parameter
				$selectedCountry = isset($_GET['district_name']) ? $_GET['district_name'] : 'bethsaida';

				// Query to retrieve members from the selected country
				$query = "SELECT * FROM member WHERE district_name = ?";
			...
			<td><a title="Click to view the Student" href="viewstudent.php?id=<?php echo $row['table_id']; ?>"><button class="btn btn-success btn-mini"><i class="icon-search"></i> View</button> </a>
			<a  title="Click to edit the Student" href="editstudent.php?id=<?php echo $row['table_id']; ?>"><button class="btn btn-warning btn-mini"><i class="icon-edit"></i> Edit</button> </a>
