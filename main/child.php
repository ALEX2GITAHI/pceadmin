...
<div class="container-fluid">
	...
	<div class="contentheader">
			<i class="icon-table"></i> Registered Church School Members
			</div>
			<ul class="breadcrumb">
...
<a  href="index.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a>
			<?php 
			include('../connect.php');
				$result = $db->prepare("SELECT * FROM children ORDER BY table_id ASC");
				$result->execute();
			...
			Total Number of Children:  <font color="green" style="font:bold 22px 'Aleo';">[<?php echo $rowcount;?>]</font>
			</div>
...
<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<?php
				...
				include('../connect.php');
				$result = $db->prepare("SELECT * FROM children ORDER BY first_name ASC");
				$result->execute();
				for($i=0; $row = $result->fetch(); $i++){
				
			?>
			<td align="center"><a href="viewstudent.php?id=<?php echo $row['table_id']; ?>" title="View Member"><?php echo $row['child_id'] ?></a></td>
