		...
		<div class="row-fluid">
			...
			<div class="span10">
				...
				<div style="margin-top: -19px; margin-bottom: 21px;">
					<a href="youthinfo.php"><button class="btn btn-default btn-large" style="float: left;"><i
								class="icon icon-circle-arrow-left icon-large"></i> Back</button></a>
					<?php
					include ('../connect.php');
					$result = $db->prepare("SELECT * FROM youth WHERE registered = 'no'");
					$result->execute();
					...
					<div style="text-align:center;">
						Total Number of Registered Youth Members: <font color="green" style="font:bold 22px 'Aleo';">
				...
				<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
					...
					<tbody>
						...
						$selectedCountry = isset($_GET['registered']) ? $_GET['registered'] : 'no';
