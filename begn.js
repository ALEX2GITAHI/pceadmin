...
{
  //let isPhoneValidated = validatePhoneNumber()
  ...
  if(  isEmailValidated && isPasswordValidated && isSubmitForm && isPhoneValidated  && isCourseValied &&  isuntyValied && isAjaxcall && isAjaxheader ){
    return true;
  }else{
    return false;
  }
...
function validatePhoneNumber(){
   var phone= document.getElementById("stemai").value;
